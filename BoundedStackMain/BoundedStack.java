...
public class BoundedStack {
    ...
    // AF(elements,capacity) คือ abstract function
    // ที่ใช้ในการอธิบายความสัมพันธ์ระหว่าง elements
    // RI
    ...
    /**
     * สร้าง BoundedStack ตัวใหม่ที่มีสลับลำดับข้อมูลแบบสุ่ม
     * 
     * @return BoundedStack ตัวใหม่ที่มีสลับลำดับข้อมูลแบบสุ่ม
     */
    ...
    /**
     * รับ element ที่อยู่บนสุดของ stack
     * 
     * @return element ที่อยู่บนสุดของ stack
     */
    public String peek() {
        if (isEmpty()) {
            throw new IllegalStateException("Stack is empty");
